...
{
    public partial class InitialCreateRental : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentalLimit = table.Column<DateTime>(type: "datetime2", nullable: true),
                    InventryDay = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Remarks = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RenewDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Canrental = table.Column<bool>(type: "bit", nullable: false),
                    Overday = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
